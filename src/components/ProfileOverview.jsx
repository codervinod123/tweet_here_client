       ...
       <div className="h-full flex flex-col">
          <div className="bg-white rounded-md bg-[url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQsIz4qZKTOplGKCIt860B8HP3mTBMZGACNFg&s')] bg-no-repeat bg-[length:100%_10%] bg-top">
              <div className="flex justify-center pt-[18%]">
                 <img className="border-2 border-white rounded" height={65} width={65} src="https://social-react-sb.vercel.app/assets/07-DLMl_mTI.jpg" alt="profile-pic" />
              </div>
              <div className="flex flex-col items-center">
                 <h1 className="font-bold text-black text-xl">Sam Lanson</h1>
                 <p className="text-gray-600 text-sm font-semibold">Web Developer at Webestica</p>
              </div>
              <p className="text-center text-sm text-gray-600 font-semibold py-4 px-4 leading-5">I'd love to change the world, but they won’t give me the source code.</p>
         ...
         <div className="my-4">
          ...
          <p className="text-blue-600 text-center text-sm font-semibold mb-4 cursor-pointer">View Profile</p>
          ...
          <p className="text-gray-500 text-center text-sm font-semibold">&copy; 2024 Tweet Here</p>
       </div>
    </nav>
  )
}
