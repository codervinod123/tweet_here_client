    ...
    <div className="bg-white px-20 py-4 justify-center items-center sticky top-0 z-10">
      <div className='flex justify-between'>
        <div className='flex gap-x-4'>
          ...
          <input type="text" placeholder='Search...' className='px-4 border border-gray-400 focus:border-none focus:outline outline-blue-600 outline-offset-0 outline-1 rounded bg-[#ECFFE6] placeholder:text-gray-400' />
        </div>
