        ...
        <div className="w-[30vw] h-[75vh] rounded bg-white">
          ...
          <div className="px-6">
            <div className="fixed -mt-6">
              <img className="h-[52px] w-[52px] rounded-full" src={user.profilePic} alt="" />
            </div>
          </div>
          <div className="mt-10 px-6">
            <div className="">
              <h1 className="text-lg text-gray-700 font-semibold leading-4">{user.name}</h1>
            ...
            <div className="grid grid-cols-6 grid-flow-col border-b py-3">
              ...
              <label htmlFor="image" className="col-span-4 cursor-pointer">
                ...
                <div className="flex">
                  ...
                  { 
                   !previewProfile ? 
                     <img className="h-[40px] w-[40px] rounded-full" src={user.profilePic} alt="" />
                      :
