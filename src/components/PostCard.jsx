    ...
    <div className="bg-white rounded-md px-8 py-4">
      ...
      <div className="">
        <p className="text-gray-600 text-base py-4">
          ...
          a aliquid quos error magni deserunt totam sunt amet vero! Numquam
          necessitatibus aut, dignissimos non fugit temporibus doloribus. Error,
          excepturi?
        </p>
        <img
              ...
              <div className="flex gap-2">
                ...
                <div className="flex bg-[#ECFFE6] rounded-md w-full p-2">
                  <div className="flex flex-col">
                    ...
                    <p>
                      Lorem ipsum dolor sit amet consectet sed in ab illum
                      minima. Quo dolores natus sapiente vitae.
                    </p>
                    <ul></ul>
                  </div>
                </div>
