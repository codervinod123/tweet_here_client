  ...
  return (
    <div className="h-screen flex justify-center flex-col ">
      ...
      <div className="px-4 flex flex-col gap-4 pt-6">
        ...
        <div className="w-full text-gray-900 cursor-pointer bg-gradient-to-r from-teal-400 to-lime-400 hover:bg-gradient-to-l hover:from-teal-400 hover:to-lime-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
          {
           loader? <Spin indicator={<LoadingOutlined spin />} size="small" />: 
          <button
            onClick={sendRequest}
            type="button"
            className=""
