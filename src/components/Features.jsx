            ...
            <div className='flex flex-wrap gap-[2rem] justify-center mb-[5rem]'>
                {
                    features.map((feature) => {
                        return (
                            <div key={feature.id} className="bg-[#fff] p-[1rem] border rounded-md w-[320px] transition-all duration-700 hover:translate-y-2">
                                <div className="gap-2 flex items-center mb-[.5rem]">
                                    <i className="text-[1.2rem] text-[#ff6f61]">
                                        { feature.icon }
                                    </i>
